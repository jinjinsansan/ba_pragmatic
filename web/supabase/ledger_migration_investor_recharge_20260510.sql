ALTER TABLE ledger_account1_daily ADD COLUMN IF NOT EXISTS investor_recharge NUMERIC(14,2) DEFAULT 0 NOT NULL;
...
INSERT INTO ledger_account1_daily (investor_id, trade_date, daily_profit, investor_recharge, notes)
VALUES ('00000000-0000-0000-0000-000000000001'::uuid, '2026-05-09'::date, 4000.00, 4000.00, 'Hさん補正期間: 全額別チャージへ自発入金 (5/9)')
ON CONFLICT (investor_id, trade_date) DO UPDATE SET
  daily_profit = EXCLUDED.daily_profit,
  investor_recharge = EXCLUDED.investor_recharge,
  notes = EXCLUDED.notes;

INSERT INTO ledger_account2_daily (investor_id, trade_date, daily_profit, withdrawal, notes)
VALUES ('00000000-0000-0000-0000-000000000001'::uuid, '2026-05-09'::date, 4212.00, 0, '5/9')
ON CONFLICT (investor_id, trade_date) DO UPDATE SET
  daily_profit = EXCLUDED.daily_profit,
...
SELECT
  ...
  investor_recharge_total,
  investor_net_received,
  investor_received_total,
  investor_overpaid,
  displayed_charge_balance,
  account2_total_profit,
  j_share_total_pool, k_share_total_pool, company_share_total_pool,
  j_unpaid_total, k_unpaid_total, company_unpaid_total,
