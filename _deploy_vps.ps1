...
ssh -i $KEY $HOST "rm -f ${DEST}/__pycache__/dual_line_*.pyc 2>/dev/null; echo pycache cleared"
...
ssh -i $KEY $HOST "tail -15 ${DEST}/dual_line_bot_service.log"
