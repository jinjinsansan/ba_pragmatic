...
LIVE_SIGNAL_PATTERNS = frozenset({
    "telecho|telecho|B",
    "telecho|nikoichi|P",
    # "telecho|niconico|P",  # EXCLUDED 2026-06-19 weak ~49% (keep counter; do not reset)
    # "niconico|niconico|B",  # EXCLUDED 2026-06-23 OOS-negative (136k re-BT)
    # "niconico|dragon|P",  # EXCLUDED 2026-06-23 OOS-negative (136k re-BT)
    "sansan|telecho|P",
    "niconico|nikoichi|P",   # ADDED 2026-06-30 (T込みOOS生存)
    "niconico|dragon|B",     # ADDED 2026-06-30
    "niconico|nikoichi|B",   # ADDED 2026-06-30
})
...
LIVE_SIGNAL_PATTERNS_V4 = frozenset({
    ...
    # "telecho|niconico|P",  # EXCLUDED 2026-06-19 weak ~49% (keep counter; do not reset)
    "niconico|nikoichi|B",
    # "telecho|niconico|B",  # EXCLUDED 2026-06-23 OOS-negative (136k re-BT)
    "niconico|dragon|B",
    "niconico|nikoichi|P",
    "telecho|nikoichi|B",
    "telecho|telecho|B",
...
def live_signal_for_history(
    ...
    """
    seq = "".join(c for c in str(history or "") if c in ("P", "B", "T"))  # ★T込み(2026-06-30)
